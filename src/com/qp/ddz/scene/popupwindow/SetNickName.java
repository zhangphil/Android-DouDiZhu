...
import com.smw.cmd.plazz.MSG_C2S_SET_NICKNAME;

public class SetNickName {

	private static final String	TAG	= "SetNickName";
    ...
    static   PopupWindow popupWindow;  
 	...
 	public static  void Show ( ) {
 		...
 		View popupview = null;
 		if (popupWindow == null) { 
 			 popupview = GameActivity.getInstance().getLayoutInflater().inflate(R.layout.setnickname, null, false);
		         ...
		         //  popupWindow.setContentView(contentView);  
		           ...
		           btnok.setOnClickListener(new OnClickListener() {
		               public void onClick(View v) {
			               ...
			               //长度最大10字符
			               if(pw1.getText().toString().length()>30){
			            	   Toast.makeText(GameActivity.getInstance(), "昵称过长!", Toast.LENGTH_SHORT).show();
			            	    return;
			               }
			              
			               
			               	//请求修改
			               MSG_C2S_SET_NICKNAME o=new MSG_C2S_SET_NICKNAME();
				    		o.cmd=CMD.C2S_SET_NICKNAME;
				    		o.nickname=pw1.getText().toString(); 
